...
class _AdminHomePageState extends State<AdminHomePage> {
  ...
  String _formatDate(String? dateString) {
    if (dateString != null && dateString.isNotEmpty) {
      try {
        // Split the date string by any separators like '/', '-', etc.
        List<String> dateParts = dateString.split(RegExp(r'[\/\-]'));

        // Parse the date parts to integers (year, month, day)
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const Gap(10),
                          Text(
                            '${_formatDate(postDataList[index]['fromdate'])} - ${_formatDate(postDataList[index]['todate'])}',
                            style: GoogleFonts.poppins(
                              fontSize: 12,
                      ...
                      Row(
                        children: [
                          ButtonWidget(
                            ...
                            colors: Colors.red,
                            click: () {
                              deletepost(postDataList[index]['id']);
                            },
